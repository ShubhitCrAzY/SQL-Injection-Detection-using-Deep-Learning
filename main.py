...
if __name__ == "__main__":
    ...
    if not os.path.exists(app.database):
        with sqlite3.connect(app.database) as connection:
            ...
            c.execute('INSERT INTO courses VALUES("Natural Language Processing", "40", "CSE4022")')
            #c.execute('INSERT INTO courses VALUES("Natural Language Programming","40","CSE4022")')
            ...
            c.execute('INSERT INTO employees VALUES("Shubhit Talus", "{}")'.format(hash_pass("123")))
            c.execute('INSERT INTO employees VALUES("Abhinav kumar", "{}")'.format(hash_pass("123")))
            #c.execute('INSERT INTO employees VALUES("Nikhil Chadda", "{}")'.format(hash_pass("123")))
            #c.execute('INSERT INTO employees VALUES("Nikhil Chadda", "{}")'.format(hash_pass("123")))
            connection.commit()
            connection.close()
